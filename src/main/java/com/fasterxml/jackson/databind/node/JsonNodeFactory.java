        ...
        JsonNodeCreator // since 2.3
{
     ...
     * String value
     */
    @SuppressWarnings("nullness") //when argument text is passed, return value will be non-null
    @Override
     ...
     * String value
     */
    @SuppressWarnings("nullness") //when argument data is passed, return value will be non-null
    @Override
